...
module Travian
  ...
  describe UriHelper do
    ...
    describe '#tld' do
      it 'returns "com" when host is "www.travian.com"' do
        obj.stub(host: 'www.travian.com')
        obj.tld.should == 'com'
      end
      ...
      it 'returns "co.uk" when host is "www.travian.co.uk"' do
        obj.stub(host: 'www.travian.co.uk')
        obj.tld.should == 'co.uk'
      end

      it 'returns "com.au" when host is "www.travian.com.au"' do
        obj.stub(host: 'www.travian.com.au')
    ...
    describe '#subdomain' do
      it 'returns "www" when uri is "www.travian.co.kr"' do
        obj.stub(host: 'www.travian.co.kr')
        obj.subdomain.should == 'www'
      end

      it 'returns "ts1" when uri is "ts1.travian.pt"' do
        obj.stub(host: 'ts1.travian.pt')
        obj.subdomain.should == 'ts1'
      end

      it 'returns "tx3" when uri is "tx3.travian.pt"' do
        obj.stub(host: 'tx3.travian.pt')
        obj.subdomain.should == 'tx3'
      end

      it 'returns "arabiats4" when uri is "arabiats4.travian.com"' do
        obj.stub(host: 'arabiats4.travian.com')
        obj.subdomain.should == 'arabiats4'
      end
    end

    describe '#hub_code' do
      it 'returns "kr" when uri is "www.travian.co.kr"' do
        obj.stub(host: 'www.travian.co.kr')
        obj.hub_code.should == "kr"
      end

      it 'returns "arabia" when uri is "arabia.travian.com"' do
        obj.stub(host: 'arabia.travian.com')
        obj.hub_code.should == "arabia"
      end

      it 'returns "arabia" when uri is "arabiatcx3.travian.com"' do
        obj.stub(host: 'arabiatcx3.travian.com')
        obj.hub_code.should == "arabia"
      end

      it 'returns "cn" when uri is "www.travian.cc"' do
        obj.stub(host: 'www.travian.cc')
        obj.hub_code.should == 'cn'
      end
    end

    describe '#server_code' do
      it 'returns nil when uri is "www.travian.com"' do
        obj.stub(host: 'www.travian.com')
        obj.server_code.should == nil
      end

      it 'returns nil when uri is "arabia.travian.com"' do
        obj.stub(host: 'arabia.travian.com')
        obj.server_code.should == nil
      end

      it 'returns "tx3" when uri is "tx3.travian.com.br"' do
        obj.stub(host: 'tx3.travian.com.br')
